...
The easiest way to create a list is with the pimped method on Array, available in monet-pimp.js or use `fromArray` alias method.

	var myList = [1,2,3].list()
	var myList2 = List.fromArray([1,2,3])
